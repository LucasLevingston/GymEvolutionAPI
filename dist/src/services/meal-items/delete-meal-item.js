...
async function deleteMealItem(id) {
    ...
    // Update meal totals
    if (mealId) {
        await (0, update_meal_totals_1.updateMealTotals)(mealId);
    }
    // Create history entry
    await (0, create_history_entry_1.createHistoryEntry)(mealItem.Meal.Diet.userId, `Meal item ${mealItem.name} deleted`);
    return true;
}
